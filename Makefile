...
ansible-k3s: ansible-first-run ansible-base
	...
	@ansible-playbook -i ansible/inventory/hosts.yaml ansible/k3s-seed.yaml --ssh-common-args='-o StrictHostKeyChecking=no' --limit sg-ctrl1